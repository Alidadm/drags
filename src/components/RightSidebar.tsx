          ...
          {widgets.map((widget) => {
            ...
            return (
              <div
                ...
                data-gs-height="1"
              >
                <div className="grid-stack-item-content bg-gradient-to-r from-white to-gray-50 p-4 rounded-lg border border-gray-200 shadow-sm hover:shadow-md transition-all cursor-move hover:border-cyan-300 group">
